              ...
              <div className="schedule--content__packages--options">
                <button
                  className={`option option__initial ${
                    activePackage === "initial" ? "option__active" : ""
                  }`}
                ...
                <button
                  className={`option option__follow-up ${
                    activePackage === "follow-up" ? "option__active" : ""
                  }`}
                  onClick={() => setActivePackage("follow-up")}
                >
                  <div className="option--head">
                ...
                <button
                  className={`option option__jumpstart ${
                    activePackage === "jumpstart" ? "option__active" : ""
                  }`}
                  onClick={() => setActivePackage("jumpstart")}
                >
                  <div className="option--head">
                ...
                <button
                  className={`option option__standard ${
                    activePackage === "standard" ? "option__active" : ""
                  }`}
                ...
                <button
                  className={`option option__premium ${
                    activePackage === "premium" ? "option__active" : ""
                  }`}
